...
class ValuesControllerTest < ActionController::TestCase
  ...
  test "should create value" do
    assert_difference('Value.count') do
      post :create, value: { date: @value.date, fat: @value.fat, user_id: @value.user_id, weight: @value.weight }
    end
  ...
  test "should update value" do
    patch :update, id: @value, value: { date: @value.date, fat: @value.fat, user_id: @value.user_id, weight: @value.weight }
    assert_redirected_to value_path(assigns(:value))
  end
